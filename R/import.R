...
#' @description Import data from Excel, text files, and statistical packages.
#' @param file datafile to import
#' @param ... parameters passed to the importing function.
#' @return data frame
#' @details The \code{import} function is a wrapper for functions in the haven, readxl, and vroom packages.
#' @examples
#' \dontrun{
#' if(interactive()){
